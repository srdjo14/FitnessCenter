...
INSERT INTO USER(role, username, password, first_name, last_name, phone, email, birth_date, active, position, type) VALUES('USER', 'srdjo14', 'fitness1', 'Srdjan', 'Protic', '0651384326', 'protic783@gmail.com', '2000-4-14', TRUE, 0, 'MEMBER')

INSERT INTO USER(role, username, password, first_name, last_name, phone, email, birth_date, active, medium_rate, fitness_center_id, position,  type) VALUES('USER', 'milos112', 'fitnedsfss1', 'Milos', 'Protic', '0653321384326', 'pro3mmm@gmail.com', '2003-4-14', TRUE, 4.0, 1, 1, 'TRAINER')
INSERT INTO USER(role, username, password, first_name, last_name, phone, email, birth_date, active, medium_rate, fitness_center_id, position,  type) VALUES('USER', 'markovic12', 'fitnes1sddd', 'Milos', 'Markovic', '0654324344326', 'markovic@gmail.com', '1999-8-14', TRUE, 3.0, 2, 1, 'TRAINER')
INSERT INTO USER(role, username, password, first_name, last_name, phone, email, birth_date, active, position,  type) VALUES('USER', 'dejana11', 'fitness111', 'Dejana', 'Protic', '065138432644', 'dejana783@gmail.com', '2000-7-26', TRUE, 2, 'ADMIN')
